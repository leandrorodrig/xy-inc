...
<html lang="en">
<head>
<title>update of products by id</title>
<style>
...
<div class="container" style="min-height: 500px">
	...
	<div class="starter-template">
	    ...
	    <br><br><br><br><br><br>
	    <h1 align="center">Update Product By ID</h1>
		...
		<form class="form-horizontal" id="search-form">
			...
			<div class="container">
	        	<div class="row">
					<div class="col-sm-3">
						<!-- Inserindo funcionalidade de UPDATE na Tela -->
...
function searchProductsByIdViaAjax() {
	...
	function updateProductsViaAjax() {
